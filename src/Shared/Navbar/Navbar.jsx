                    ...
                    <div className="navbar bg-orange-400 text-2xl  md:text-3xl ">
                        <div className="navbar-start">
                            <div className="dropdown">
                                ...
                                <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 sticky top-0 z-[69696969696]">
